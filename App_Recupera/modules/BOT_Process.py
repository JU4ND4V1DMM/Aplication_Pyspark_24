...
def Function_Complete(path, output_directory, Partitions, Wallet_Brand, Origins_Filter, Dates, Benefits, Contacts_Min, Value_Min, Value_Max):
    ...
    for Type_Proccess in BOT_list:
        BOT_Process(Data_Frame, Wallet_Brand, Origins_Filter, output_directory, \
                    Partitions, Type_Proccess, Dates, Benefits, Contacts_Min, Value_Min, Value_Max)
...
def BOT_Process (Data_, Wallet_Brand, Origins_Filter, Directory_to_Save, Partitions, Type_Proccess, Dates, Benefits, Contacts_Min, Value_Min, Value_Max):
...
def Function_Filter(RDD, Dates, Benefits, Contacts_Min, Value_Min, Value_Max):
    ...
    RDD.withColumn(
        "DTO_Filter", 
        when((col("descuento") == "0%") | (col("descuento").isNull()) | (col("descuento") == "N/A"), lit("Without_DTO"))
