...
def Function_Complete(path, output_directory, partitions, Wallet_Brand, Origins_Filter, Dates, Benefits, Contacts_Min, Value_Min, Value_Max):
    ...
    Data_Frame = EMAIL_Proccess(Data_Frame, Wallet_Brand, output_directory, partitions, \
                                Origins_Filter, Dates, Benefits, Value_Min, Value_Max)
...
def EMAIL_Proccess (Data_, Wallet_Brand, Directory_to_Save, partitions, Origins_Filter, Dates, Benefits, Value_Min, Value_Max):
    ...
    Save_Data_Frame(Data_, Directory_to_Save, partitions, Type_File)
