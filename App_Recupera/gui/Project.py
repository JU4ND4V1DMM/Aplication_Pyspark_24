...
class Process_Data(QtWidgets.QMainWindow):
    ...
    def __init__(self, row_count, file_path, folder_path, partitions):
        ...
        self.process_data = uic.loadUi("C:/Users/juan_/Downloads/App_Recupera/gui/Project.ui")
    ...
    def exec_process(self):
        ...
        self.process_data.pushButton_Graphic.clicked.connect(self.validation_data)
