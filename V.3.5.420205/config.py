...
from utils import SMS_Process, IVR_Process, EMAIL_Process, BOT_Process, Phone_Process_Order
...
def process_order_mins(folder_path, file_path, partitions):

    Phone_Process_Order.Function_Complete(file_path, folder_path, partitions)
    messagebox.showinfo("Éxito", "Archivo guardado con éxito.")