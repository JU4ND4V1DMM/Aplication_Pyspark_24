...
def Function_Complete(path, Wallet_Brand, output_directory, Partitions, Type_Proccess):

    Data_Frame = First_Changes_DataFrame(path)
    Data_Frame = Phone_Data(Data_Frame)
    Data_Frame = BOT_Process(Data_Frame, Wallet_Brand, output_directory, Partitions, Type_Proccess)
...
def Save_Data_Frame (Data_Frame, Directory_to_Save, Partitions, Wallet_Brand, Type_Proccess):
...
def BOT_Process (Data_, Wallet_Brand, Directory_to_Save, Partitions, Type_Proccess):
    ...
    Save_Data_Frame(Data_, Directory_to_Save, Partitions, Wallet_Brand, Type_Proccess)
...
#File_Name = "reporte_clientes2_21_03_2024_0830_Multimarca_BOT"
#Wallet_Brand = ["0", "30", "60", "90", "prechurn", "castigo"]
#Wallet_Brand = ["0"]
#Type_Proccess = "ServiceBots"
#Type_Proccess = "WiseBot"
...
#Function_Complete(path, Wallet_Brand, output_directory, Partitions, Type_Proccess)