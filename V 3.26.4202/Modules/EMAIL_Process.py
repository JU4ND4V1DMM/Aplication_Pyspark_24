...
def Save_Data_Frame (Data_Frame, Directory_to_Save, partitions, Wallet_Brand):
    ...
    Type_File = f"EMAIL_Marca_Wallet_Brand_"
...
#File_Name = "reporte_clientes2_18_03_2024_0830_Multimarca"
...
#Function_Complete(path, Wallet_Brand, output_directory, partitions)