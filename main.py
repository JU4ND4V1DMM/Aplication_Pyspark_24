...
def enter_data():
    folder_path = folder_entry.get() + os.path.sep
    ...
    if process == "SMS":
        ...
        config.process_data(folder_path, file_path, process, partitions)
...
process_combobox = ttk.Combobox(info_frame, values=["SMS", "EMAIL", "IVR", "IVR_TRANS", "BOT_2"])
