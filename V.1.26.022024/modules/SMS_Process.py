...
def SMS_Proccess (Data_, Wallet_Brand, Directory_to_Save, Type_Proccess):
    ...
    Data_ = Data_.withColumn("Hora_Envio", lit("14"))
    Data_ = Data_.withColumn("Hora_Real", lit("14:00"))
...
File_Name = "reporte_clientes2_24_02_2024_1200"
Wallet_Brand = "castigo"
Type_Proccess = "FLASH"
...
Function_Complete(path, Wallet_Brand, output_directory, Type_Proccess)